...
* FIX: Expand Block - Fixed infinite loop issue.
* FIX: Review Block - Preserved HTML formatting in item labels.

= 3.5.3 =

* FIX: All Blocks - Enhanced security with improved output escaping and sanitization.
